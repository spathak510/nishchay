...
def bck(data):
  ...
  squarify.plot(sizes=df1['value'], label=labels, color=['#1e90ff', '#1e90ff', '#ff6600', '#ff6700'], alpha=.8, bar_kwargs=dict(linewidth=2, edgecolor="#f2f0f0"),text_kwargs={'fontsize':12, 'wrap':True})
