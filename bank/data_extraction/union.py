...
def union_digitization(pdf_path,pdf_password):
    ...
    passcode=''
    try :
        tables = tabula.read_pdf(pdf_path,password=passcode, pages='1', guess=True)
    except :
    ...
    if structure == 'new' :
        ...
        info = tabula.read_pdf(pdf_path, pages='1',area=[54,12,310,745], pandas_options={'header':None})
    ...
    ### DIGITIZING 'netbanking' structure 
        ...
        other_details_list =  tabula.read_pdf(pdf_path, pages=1, area=[0,0,420,576],columns=[288])
